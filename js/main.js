  ...
  "slug": "decision-dock",
  "title": "Decision Dock",
  "tagline": "Queue hard decisions, compare options, and keep the chosen path visible.",
  "domainLabel": "decisions",
  "itemLabel": "decision",
  "emptyTitle": "No decisions yet",
  "emptyBody": "Add a live decision and compare the paths in one place.",
  "seedTitle": "Decision dock",
  "seedSubtitle": "A calmer queue for the choices that shape the next quarter.",
  "categories": [
    "Product",
    "Hiring",
    "Tooling",
  ...
  "items": [
    {
      ...
      "score": 9,
      "effort": 4,
      "note": "Compare simple entry pricing against a higher-touch premium path."
    },
    {
      "title": "Choose the next browser automation tool",
      "category": "Tooling",
      "state": "Open",
      "score": 6,
      "effort": 3,
      "note": "Reliability matters more than feature count here."
    },
    {
      "title": "Delay a contractor hire",
      "category": "Hiring",
      "state": "Deferred",
      "score": 5,
      "effort": 2,
      "note": "Only worth revisiting after the offer and funnel are clearer."
    }
  ]
};
