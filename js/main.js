const SPEC = {
  "slug": "decision-dock",
  "title": "Decision Dock",
  "description": "Queue hard decisions, compare options, and keep the chosen path visible.",
  "lede": "Make decisions clearer with owners, next steps, conviction scoring, and review dates.",
  "heroEyebrow": "Decision workspace",
  "boardTitle": "Decision dock board",
  "boardSubtitle": "A local-first board for hard calls, tradeoffs, and keeping the chosen path visible.",
  "accent": "Decisions get easier when ownership, next review, and conviction are visible instead of trapped in your head.",
  "itemLabel": "decision",
  "itemPluralLabel": "Decisions",
  "labels": {
    "title": "Decision",
    "note": "Decision note",
  ...
  "textOne": {
    "label": "Owner",
    "default": "Who owns the call"
  },
  "textTwo": {
    "label": "Next step",
    "default": "What happens after the choice"
  },
  "date": {
    "label": "Review date"
  },
  ...
  "defaults": {
    "note": "Write the real tradeoff here so the decision survives future second-guessing."
  },
  "stats": {
    "totalLabel": "Decisions",
    "motionLabel": "Being compared",
    "dueLabel": "Need review"
  },
  "insights": {
    "topLabel": "Most important open call",
    "dateLabel": "Next review slot",
    "metricLabel": "Highest conviction"
  },
  "queue": {
    "eyebrow": "Decision queue",
    "title": "Which calls deserve attention next",
    "empty": "Chosen and parked decisions leave the active queue."
  },
  "mix": {
    "eyebrow": "Decision mix",
    "title": "Where the hard calls are clustered"
  },
  "emptyTitle": "No decisions yet",
  "emptyBody": "Add the strategic, product, ops, and hiring decisions that need a real landing place.",
  "actions": [
    {
      "id": "compare",
      ...
      "days": 2,
      "fromToday": true,
      "toast": "Moved this decision into active comparison."
    },
    {
      "id": "raise-conviction",
      ...
      "mode": "advance",
      "metricDelta": 1,
      "toast": "Raised conviction on this path."
    },
    {
      "id": "choose",
      "label": "Choose path",
      ...
      "days": 0,
      "fromToday": true,
      "toast": "Marked this decision chosen."
    }
  ],
  "theme": {
    "primary": "#818cf8",
  ...
  "items": [
    {
      ...
      "date": "2026-04-25",
      "note": "The right answer depends on what earns credibility faster, not what looks more ambitious."
    },
    {
      ...
      "date": "2026-04-29",
      "note": "This should be triggered by pressure signals, not vague future optimism."
    },
    {
      ...
      "date": "2026-04-24",
      "note": "A simpler first model makes learning faster."
    }
  ]
};
